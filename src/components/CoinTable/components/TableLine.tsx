...
const TableLine: React.FC<ITAbleLineProps> = ({name, fullName, img, price, high24, low24, volume24, change24}) => {

  return (
    <TableRow>
      <TableCell sx={{display: "flex", alignItems: "center"}}>
        <Avatar src={`${config.imgUrl}${img}`} alt={`${name}`} sx={{height: "50px", width: "50px", mr: "10px"}}/>
